...
{
    public class SkeletonLordFirstAttackState : BaseEnemyState
    {
        public SkeletonLordFirstAttackState(EnemyAnimator enemyAnimator, AnimationDataContainer animationData,
